class Robot {
    ...
    moveUp(grid: string[][], boxes: Box[]): boolean {
    ...
    moveRight(grid: string[][], boxes: Box[]): boolean {
    ...
    moveDown(grid: string[][], boxes: Box[]): boolean {
    ...
    moveLeft(grid: string[][], boxes: Box[]): boolean {
...
class WideBox extends Box {
    ...
    checkUp(grid: string[][], boxes: WideBox[]): boolean {
        let upPos = [this.position[0]-1, this.position[1]];
    ...
    checkDown(grid: string[][], boxes: WideBox[]): boolean {
        let downPos = [this.position[0]+1, this.position[1]];
    ...
    moveUp(grid: string[][], boxes: WideBox[]): boolean {
        let upPos = [this.position[0]-1, this.position[1]];
        let leftTile = grid[upPos[0]][upPos[1]];
        let rightTile = grid[upPos[0]][upPos[1]+1];
        if (leftTile == "#" || rightTile == "#") {
    ...
    moveRight(grid: string[][], boxes: WideBox[]): boolean {
        let rightPos = [this.position[0], this.position[1]+1];
    ...
    moveDown(grid: string[][], boxes: WideBox[]): boolean {
        let downPos = [this.position[0]+1, this.position[1]];
        let leftTile = grid[downPos[0]][downPos[1]];
        let rightTile = grid[downPos[0]][downPos[1]+1];
        if (leftTile == "#" || rightTile == "#") {
    ...
    moveLeft(grid: string[][], boxes: WideBox[]): boolean {
        let leftPos = [this.position[0], this.position[1]-1];
        let tile = grid[leftPos[0]][leftPos[1]];
        if (tile == "#") {
            return false;
...
export function solution(input: string, wide: boolean): string {
    ...
    try {
        ...
        let gridLines: string[] = sections[0].split("\n");
